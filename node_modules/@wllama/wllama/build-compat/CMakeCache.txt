...
# For build in directory: /source/build-compat
...
//ASM compiler
CMAKE_ASM_COMPILER:STRING=/emsdk/upstream/emscripten/emcc
...
CMAKE_CROSSCOMPILING_EMULATOR:UNINITIALIZED=/emsdk/node/22.16.0_64bit/bin/node
...
//Path to emdawnwebgpu_pkg
EMDAWNWEBGPU_DIR:PATH=/source/build/emdawn/emdawnwebgpu_pkg
...
//ggml: use Level Zero API in SYCL backend
GGML_SYCL_SUPPORT_LEVEL_ZERO:BOOL=ON
...
//llama: build the unified binary
LLAMA_BUILD_APP:BOOL=OFF
...
//llama: use prebuilt UI from HF Bucket when available (requires
// LLAMA_BUILD_UI=ON)
LLAMA_USE_PREBUILT_UI:BOOL=ON

//Use system libggml
LLAMA_USE_SYSTEM_GGML:BOOL=OFF

//llama: use 64-bit memory in WASM builds
LLAMA_WASM_MEM64:BOOL=OFF
...
//No help, variable specified on the command line.
WLLAMA_COMPAT:UNINITIALIZED=ON

//ggml: path to ZenDNN installation
ZENDNN_ROOT:BOOL=OFF

//Value Computed by CMake
ggml_BINARY_DIR:STATIC=/source/build-compat/llama.cpp/ggml

//Value Computed by CMake
ggml_IS_TOP_LEVEL:STATIC=OFF

//Value Computed by CMake
ggml_SOURCE_DIR:STATIC=/source/llama.cpp/ggml

//Value Computed by CMake
llama.cpp_BINARY_DIR:STATIC=/source/build-compat/llama.cpp

//Value Computed by CMake
llama.cpp_IS_TOP_LEVEL:STATIC=OFF

//Value Computed by CMake
llama.cpp_SOURCE_DIR:STATIC=/source/llama.cpp

//Value Computed by CMake
wllama_BINARY_DIR:STATIC=/source/build-compat

//Value Computed by CMake
wllama_IS_TOP_LEVEL:STATIC=ON

//Value Computed by CMake
wllama_SOURCE_DIR:STATIC=/source
...
CMAKE_CACHEFILE_DIR:INTERNAL=/source/build-compat
...
GGML_AVAILABLE_BACKENDS:INTERNAL=ggml-cpu;ggml-webgpu
...
_GNUInstallDirs_LAST_CMAKE_INSTALL_PREFIX:INTERNAL=/emsdk/upstream/emscripten/cache/sysroot
//Path to a program.
